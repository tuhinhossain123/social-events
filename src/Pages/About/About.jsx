  ...
  return (
    <div className="p-5 mb-10 px-10">
      ...
      <p className="mt-5 text-lg text-left">
        ...
        mission is to be your trusted partner in orchestrating remarkable social
        events. We take your dreams, ideas, and aspirations and weave them into
        an immersive experience that captivates and mesmerizes your guests. Our
        unwavering commitment is to ensure that every moment of your event is
